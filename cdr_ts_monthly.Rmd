...
#adds 2 sigma lines
  ...
  abline(sie_trend[["coefficients"]][["(Intercept)"]]-2*anomaly_sd,sie_trend[["coefficients"]][["t"]])
=======
  abline(sie_trend[["coefficients"]][["(Intercept)"]]+anomaly_sd,sie_trend[["coefficients"]][["t"]], lty=6)+
  abline(sie_trend[["coefficients"]][["(Intercept)"]]-anomaly_sd,sie_trend[["coefficients"]][["t"]], lty=6)+

#adds 2 sigma lines
abline(sie_trend[["coefficients"]][["(Intercept)"]]+2*anomaly_sd,sie_trend[["coefficients"]][["t"]], lty=3)+
  abline(sie_trend[["coefficients"]][["(Intercept)"]]-2*anomaly_sd,sie_trend[["coefficients"]][["t"]], lty=3)

#legend(1, NULL, legend = c('','1 sd','2 ds'))
>>>>>>> 211ae161dce5664a03b35f2e143ba63898adcf77
