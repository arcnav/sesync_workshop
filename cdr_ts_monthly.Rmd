...
#cells with sic < 15 mean no ice extent. cells with sic >= 15 are
sie <- replace(sic, sic>=.15, 1)
sie <- replace(sie, sie<.15, 0)
...
plot(1979:2020, icearea_sep, type = 'b',
     main = 'September Total Arctic Sea Ice Area',
     xlab = 'Year',
     ylab = 'Ice Area (million km^2)')
